        ...
        <div class="main">
			...
			<div class="search-warp-type">
				...
				<div class="generalorder"style="padding-left: 20px; ">
					...
					-->
					<button onclick="search_interface.php?search=<?php echo $search;?>&amp;order=0" class="gengralorder-buttom" style="border-radius: 5px 5px 5px 5px;">新鲜出炉</button>
					<button onclick="search_interface.php?search=<?php echo $search;?>&amp;order=1" class="gengralorder-buttom" style="border-radius: 5px 5px 5px 5px;">最高评分</button>
					<button onclick="search_interface.php?search=<?php echo $search;?>&amp;order=2" class="gengralorder-buttom" style="border-radius: 5px 5px 5px 5px;">最多参与</button>
