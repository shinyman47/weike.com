...
<form action="register_do.php" method="get" id="form1" onsubmit="return checkform()">
    <table class="login_register_table">
		...
		<datalist id="option">
		  ...
		  <option value="我的父亲名字">
		  <option value="我的生日">
		  <option value="我吃火锅最尴尬的一件事">
		  <option value="我出生的城市">
		</datalist>
		<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
		<tr><td><strong><font size="3" color="white">密保答案</font></strong></td><td>&nbsp;</td><td><input type="text" name="quesan" class="form-control" id="quesan" placeholder="你的密保答案" ></td></tr>
		<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
