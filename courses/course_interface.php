		...
		<div class="main">
			<div class="course-warp">
				...
				<div class="course-warp-main">
					...
					<div class="right">
                        ...
                        <?php
                        $sql1="select * from sub WHERE username='$username' and lesson_id=$lesson_id";
                        $result1=mysqli_query($conn,$sql1);
                        $total = mysqli_num_rows($result1);
                        if($total==0) {
                            ?>
                            <form action="sub.php" method="get">
                                <input type="submit" class="btn btn-primary" value="立即参加" style="width: 150px;height: 60px; border: none; background-color: #ff0000; font-size: 20px;">
                            </form>
                            <?php
                        }
                        else {
                            ?>
                            <input type="submit" class="btn btn-primary" value="您已订阅">
                            <?php
                        }
                        ?>
                    </div>
			...
			<div class="course-msg">
				<div class="course-msg-warp">
                    ...
                    <div class="course-msg-comment">
                        ...
                        <div class="addcomment">
							...
							<input type="text" name="text" id="text" class="content" placeholder="  我也来说两句……" style="height: 130px;"/>
                            <input type="submit" class="btn btn-primary" value="sub" style="background-color: #ff0000; border: none;">
                            </form>
						</div>
				...
				<div class="course-msg-teach">
					...
					<h4 style="float: right; padding-right: 100px; padding-top: 20px;"><?php echo $info["teacher"]?></h4>
